...
function RequestLogger({ logEntries = [], stats = null }) {
...
function renderLogEntry(entry) {
  ...
  const statusClass = entry.success ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200';
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', { key: 'creds' }, `${entry.credentialType}${entry.duration ? ` • ${entry.duration}ms` : ''}`)
      ])
    ]),
...
module.exports = { RequestLogger, EmptyRequestLogger };
